<script>
	...
	import {getElementGeometry} from 'app/utils/domUtils';
	...
	beforeUpdate(({changed, current, previous}) => {
	...
	const setGeometry = () => {
		...
		width = elementGeometry.width;
		height = elementGeometry.height;
	};
...
<div this:layers class='layers'
	on:mouseenter={onmouseenter}
	on:mouseleave={onmouseleave}
	on:wheel={onwheel}
>
	<div this:mapcontainer class='mapcontainer'></div>
