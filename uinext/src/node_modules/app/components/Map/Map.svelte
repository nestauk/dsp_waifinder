<script>
	...
	$: boundingBox1 = bbox(toGeoPoints([
		{
			Latitude: 25.2223186,
			Longitude: 55.1579517
		},
		{
			Latitude: 25.2241651,
			Longitude: 55.1606916
		}
	]));
	$: boundingBox = {
		...boundingBox1,
	...
	beforeUpdate(() => {
		console.log('vp', viewport, height, mapCreated)
	...
	const setGeometry = () => {
		...
		console.log('compstyl', getComputedStyle(mapcontainer))
		...
		console.log('elemGeo', width, height)
	};
