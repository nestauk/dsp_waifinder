<script>
	...
	import {_showThemeEditor, _currThemeVars} from 'app/stores/theme';
...
>
	...
	{/if}
	{#if isServerSide || !$_screen?.sizes.medium && showMenu || $_screen?.sizes.medium}
