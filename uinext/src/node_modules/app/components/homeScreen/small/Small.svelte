<script>
	...
	import {_heroMarker} from 'app/stores/interaction';
...
<div class='container'>
	...
	{#if $_heroMarker?.org}
		<OrgBanner details={$_heroMarker.org} />
	{/if}

	{#if $_activeTopicDetails}
		<TopicBanner details={$_activeTopicDetails} />
	{/if}
</div>
