<script>
	...
	import ArrowDownCircle from '@svizzle/ui/src/icons/feather/ArrowDownCircle.svelte';
	import ArrowUpCircle from '@svizzle/ui/src/icons/feather/ArrowUpCircle.svelte';
			...
			<div class='descriptionUI'>
				...
				{#if isEllipsisActive}
					<div on:click={toggleFolded}>
						<Icon glyph={isFolded ? ArrowDownCircle : ArrowUpCircle} />
					</div>
				{/if}
			</div>
		{/if}
