...
export const defaults = {
	bbox_WS_EN: bbox_WS_EN_UK,
	orgSearchValue: '',
	orgTypesSelectionMode: orgTypesSelectionModes[0],
	placesSearchValue: '',
	selectedOrgTypes: []
};

export const _bbox_WS_EN = writable(defaults.bbox_WS_EN);
...
export const _selectedOrgTypes = writable(defaults.selectedOrgTypes);
export const toggleOrgType = type =>
	_selectedOrgTypes.update(
		orgTypes => _.sort(toggleItem(orgTypes, type))
	);

export const _orgTypesSelectionMode = writable(defaults.orgTypesSelectionMode);
...
export const _orgSearchValue = writable(defaults.orgSearchValue);
export const _orgSearchRegex = derived(_orgSearchValue, safeRegexOf);

/* place search */

export const _placesSearchValue = writable(defaults.placesSearchValue);
